...
RUN apt-get update && apt-get install -y liblzma-dev libbz2-dev zlib1g libpng-dev libxml2-dev \
    gfortran-7 libglpk-dev libhdf5-dev libcurl4-openssl-dev python3 python3-dev python3-pip

RUN pip3 install numpy==1.20 pandas umap-learn leidenalg igraph anndata
